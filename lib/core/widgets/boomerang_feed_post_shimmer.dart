...
class BoomerangFeedPostShimmer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Must match the caption [Padding] + inner [Column] below (for tight parents).
    final footerH = 8.h + 8.h + 16.h + 8.h + 14.h + 6.h + 14.h;
    ...
    return ShimmerScope(
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          const aspect = 3 / 4;
          final intrinsicMediaH = maxW / aspect;

          var mediaH = intrinsicMediaH;
          final maxH = constraints.maxHeight;
          if (maxH.isFinite) {
            final roomForMedia = maxH - footerH;
            if (roomForMedia < intrinsicMediaH) {
              mediaH = roomForMedia > 0 ? roomForMedia : 0;
            }
          }
